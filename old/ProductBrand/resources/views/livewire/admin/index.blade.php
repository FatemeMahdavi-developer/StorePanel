...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">برند</h2>
    </div>
                ...
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        @foreach ($product_brands as $product_brand )
                            <tr class="text-center"  wire:key="task-{{ $product_brand->id }}">
                                <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                    <input type="checkbox" value="{{$product_brand->id}}" wire:model="items" >
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{$product_brand->date_convert()}}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark flex justify-center">
                                    <x-admin.state :state="$product_brand->state" :id="$product_brand->id"></x-admin.state>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center justify-center space-x-3.5">
                                        <a wire:navigate href="{{route("admin.brand.edit",['brand'=>$product_brand->id])}}" class="hover:text-primary ml-3">
                                        ...
                                        <button wire:click="delete({{$product_brand->id}})"   >
                                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
