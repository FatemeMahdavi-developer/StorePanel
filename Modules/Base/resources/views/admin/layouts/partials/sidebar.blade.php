<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
  class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0" @click.outside="sidebarToggle = false">
  ...
  <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
    ...
    <!-- Menu Group -->
    <div>
    <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">منو                            </h3>
        ...
        <li>
            ...
            <div class="translate transform overflow-hidden" :class="(selected === 'Dashboard') ? 'block' :'hidden'">
                <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                    <li>
                        <a wire:navigate class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="{{route("admin.productbrand.create")}}"
                        :class="page === 'ecommerce' && '!text-white'">
                        افزودن
                        </a>
                    </li>
        ...
        <li>
            ...
            <div class="translate transform overflow-hidden" :class="(selected === 'Dashboard') ? 'block' :'hidden'">
                <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                    <li>
                        <a wire:navigate class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="{{route("admin.questioncat.create")}}"
                        :class="page === 'ecommerce' && '!text-white'">
                        افزودن
                        </a>
                    </li>
                    <li>
                        <a wire:navigate class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="{{route("admin.questioncat.index")}}"
                        :class="page === 'ecommerce' && '!text-white'">
                        لیست دسته بندی پارامتر
                        </a>
                    </li>
