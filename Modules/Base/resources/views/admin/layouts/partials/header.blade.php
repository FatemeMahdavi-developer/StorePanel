<div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <a class="block flex-shrink-0 lg:hidden" href="index.html">
        <img src="{{asset("admin/assets/images/logo/logo-icon.svg")}}" alt="Logo" />
      </a>
    </div>
    <div class="hidden sm:block">
      <form action="" method="POST" >
        <div class="relative">
          ...
          <input type="text" placeholder=" جستجو... " class="w-full bg-transparent pl-9 pr-4 focus:outline-none xl:w-125 border-transparent"/>
        </div>
      </form>
    </div>
    <div class="flex items-center gap-3 2xsm:gap-7">
      <ul class="flex items-center gap-2 2xsm:gap-4">
        <li>
          <label :class="darkMode ? 'bg-primary' : 'bg-stroke'" class="relative m-0 block h-7.5 w-14 rounded-full">
            ...
            />
            <span
              :class="darkMode && '!translate-x-full'"
          ...
          >
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset("admin/assets/images/user/user-02.png")}}" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset("admin/assets/images/user/user-01.png")}}" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset("admin/assets/images/user/user-03.png")}}" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset("admin/assets/images/user/user-04.png")}}" alt="User" />
                  </div>
      ...
      >
        ...
        >
          ...
          <a href="{{route('admin.logout')}}" class="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
