<div class="mx-auto max-w-screen-2xl p-4 sm:p-6 2xl:p-10">
    ...
    <div class="grid grid-cols-1 gap-9 mb-12">
        ...
        <x-base::admin.form submit="update" has_File="true">
            ...
            <x-base::admin.select2_multiple name="product_brands_selected" title="برند" :value="$product_brands_selected" :items="$product_brands" ></x-base::admin.select2_multiple>
